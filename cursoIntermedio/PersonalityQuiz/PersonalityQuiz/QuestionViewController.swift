...
class QuestionViewController: UIViewController {
    ...
    @IBAction func multipleAnswerButtonPressed() {
        let currentAnswwers = questions[questionIndex].answers
        
        if multiSwitch1.isOn{
            answersChosen.append(currentAnswwers[0])
        }
        if multiSwitch2.isOn{
            answersChosen.append(currentAnswwers[1])
        }
        if multiSwitch3.isOn{
            answersChosen.append(currentAnswwers[2])
        }
